...
public class MultiSessionTelegramBot extends TelegramLongPollingBot {
    ...
    public String getCallbackQueryButtonKey() {
        return updateEvent.get().hasCallbackQuery() ? updateEvent.get()
    ...
    private <T extends Serializable, Method extends BotApiMethod<T>> T
    executeTelegramApiMethod(Method method) {
        try {
